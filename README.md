...
Run `flatpak install --user https://raw.githubusercontent.com/WhyKickAmooCow/flathub/io.github.jeffvli.feishin/feishin.flatpakref` to use the repository, or download the [latest build](https://nightly.link/WhyKickAmooCow/flathub/workflows/flatpak-bundle/io.github.jeffvli.feishin/feishin-x86_64) from GHA and install manually.
